...
./main -f ${dir}/lim3.svg -l 200 -w 140 -h 80 -b 40 -t 10 -q 5 >/dev/null || echo "  Echec du test"
...
./main -f ${dir}/lim4.svg -l 80 -w 80 -h 80 -b 40 -t 10 -q 5 >/dev/null || echo "  Echec du test"
...
./main -f ${dir}/lim5.svg -l 200 -w 80 -h 80 -b 40 -t 15 -q 5  >/dev/null|| echo "  Echec du test
"
echo "  Cas q>l-4t"
...
./main -f ${dir}/lim6.svg -l 200 -w 100 -h 205 -b 100 -t 10 -q 40  >/dev/null || echo "  Echec du test"
...
./main -f ${dir}/lim7.svg -l 100 -w 40 -h 80 -b 50 -t 5 -q 18  >/dev/null || echo "  Echec du test"
...
./main -f ${dir}/lim8.svg -l 200 -w 140 -h 80 -b 50 -t 10 -q 29  >/dev/null || echo "  Echec du test"
...
./main -f ${dir}/lim9.svg -l 200 -w 140 -h 104 -b 50 -t 5 -q 44  >/dev/null || echo "  Echec du test"
...
#   --couleur : pour modifier la couleur des lignes dans le svg final
echo "  Option --couleur"
./main -f ${dir}/bleu.svg -l 200 -w 140 -h 80 -b 50 -t 5 -q 10 --couleur blue >/dev/null || echo "  Echec du test"
./main -f ${dir}/vert.svg -l 200 -w 140 -h 80 -b 50 -t 5 -q 10 --couleur green >/dev/null || echo "  Echec du test"

#   --epaisseur : pour modifier l'epaisseur des lignes dans le svg final
echo "  Option --epaisseur"
./main -f ${dir}/epaisseur1.svg -l 200 -w 140 -h 80 -b 50 -t 5 -q 10 --epaisseur 1 >/dev/null || echo "  Echec du test"
./main -f ${dir}/epaisseur0.5.svg -l 200 -w 140 -h 80 -b 50 -t 5 -q 10 --epaisseur 0.5 >/dev/null || echo "  Echec du test"

#   --min-marge : pour modifier la longueur minimale des queues encoches de longueur =/= q
echo "  Option --min-marge"
./main -f ${dir}/min-marge5.svg -l 144 -w 144 -h 74 -b 50 -t 5 -q 10 --min-marge 5 >/dev/null || echo "  Echec du test"
./main -f ${dir}/min-marge2.svg -l 144 -w 144 -h 74 -b 50 -t 5 -q 10 --min-marge 2 >/dev/null || echo "  Echec du test"

#   --marge-svg : pour modifier la distance entre les polygones dans le fichier svg
echo "  Option --marge-svg"
./main -f ${dir}/marge1.svg -l 140 -w 140 -h 70 -b 40 -t 5 -q 5 --marge-svg 1 >/dev/null || echo "  Echec du test"
./main -f ${dir}/marge20.svg -l 140 -w 140 -h 70 -b 40 -t 5 -q 5 --marge-svg 20 >/dev/null || echo "  Echec du test"
